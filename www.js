...
var ie = (s, e, t) =>
  ...
  C = (s, e) => {
    ...
    if (se) for (var t of se(e)) Oe.call(e, t) && ie(s, t, e[t]);
    return s;
  },
  O = (s, e) => Se(s, ke(e));
const V =
...
class oe {
  ...
  get styleSheet() {
    ...
    return (
      V &&
        e === void 0 &&
        (re.set(this.cssText, (e = new CSSStyleSheet())),
...
class A extends HTMLElement {
  ...
  requestUpdate(e, t, i) {
    let r = !0;
    e !== void 0 &&
      (((i = i || this.constructor.getPropertyOptions(e)).hasChanged || ae)(
        this[e],
        t
      )
...
const L = globalThis.trustedTypes,
  he = L ? L.createPolicy("lit-html", { createHTML: (s) => s }) : void 0,
    ...
    for (let l = 0; l < t; l++) {
        ...
        (v = n.lastIndex),
          n === T
            ? c[1] === "!--"
              ...
              ? (n = pe)
              : c[2] !== void 0
              ? (fe.test(c[2]) && (r = RegExp("</" + c[2], "g")), (n = w))
              : c[3] !== void 0 && (n = w)
            : n === w
            ? c[0] === ">"
              ? ((n = r != null ? r : T), (u = -1))
      ...
      o +=
        n === T
          ? a + Te
          : u >= 0
          ? (i.push(g), a.slice(0, u) + "$lit$" + a.slice(u) + _ + B)
          : a + _ + (u === -2 ? (i.push(void 0), l) : B);
    }
  ...
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    for (; (r = S.nextNode()) !== null && l.length < h; ) {
      if (r.nodeType === 1) {
        ...
        if (r.data === ce) l.push({ type: 2, index: o });
        else {
          let c = -1;
...
($.finalized = !0),
  ...
  (Z = globalThis.litElementHydrateSupport) === null ||
    Z === void 0 ||
    Z.call(globalThis, { LitElement: $ });
const _e = globalThis.litElementPolyfillSupport;
_e == null || _e({ LitElement: $ });
...
var G = y`:host{font-family:ui-monospace,system-ui,Helvetica,"Arial Narrow",Roboto,Oxygen,Ubuntu,sans-serif;color-scheme:light dark;--primary-color:#03a9f4;transition:all 350ms!important}`,
  ...
  ye = (s, e, t, i) => {
    for (
      var r = i > 1 ? void 0 : i ? We(e, t) : e, o = s.length - 1, n;
      o >= 0;
      o--
    )
  ...
  ee = class extends $ {
    ...
    select(s, e, t, i, r) {
      return d`<select @change="${(o) => {
        ...
        this.restAction(s, `${e}?${t}=${encodeURIComponent(n)}`);
      }}">${i.map(
    ...
    control(s) {
      ...
      if (s.domain === "light")
        return [
          this.switch(s),
          s.brightness
            ? this.range(s, "turn_on", "brightness", s.brightness, 0, 255, 1)
            : "",
          s.effects.filter((e) => e != "None").length
            ? this.select(s, "turn_on", "effect", s.effects, s.effect)
            : "",
        ];
      if (s.domain === "lock")
        return d`${this.actionButton(
          s,
          "\u{1F510}",
          "lock"
        )} ${this.actionButton(s, "\u{1F513}", "unlock")} ${this.actionButton(
          s,
          "\u2191",
          "open"
        )}`;
      ...
      if (s.domain === "climate") {
        ...
        return (
          ...
          }, Target: ${t}</label> ${e}<br>Mode: ${s.modes.map(
            (i) =>
              d`<label><input type="radio" name="${
                s.unique_id
              }_mode" @change="${(r) => {
                var n;
                let o = (n = r.target) == null ? void 0 : n.value;
                this.restAction(s, `set?mode=${o}`);
              }}" value="${i}" ?checked="${s.mode === i}">${i}</label>`
          )}`
        );
      }
      return d``;
    ...
    render() {
      return d`<table><thead><tr><th>Name</th><th>State</th><th>Actions</th></tr></thead><tbody>${this.entities.map(
        (s) =>
          d`<tr><td>${s.name}</td><td>${s.state}</td><td>${this.control(
            s
          )}</td></tr>`
      )}</tbody></table>`;
    }
...
ye([z({ type: Array, reflect: !0 })], ee.prototype, "entities", 2);
...
te([f({ type: Number })], I.prototype, "rows", 2);
...
var Ze = Object.defineProperty,
  ...
  b = (s, e, t, i) => {
    for (
      var r = i > 1 ? void 0 : i ? Ye(e, t) : e, o = s.length - 1, n;
      o >= 0;
      o--
    )
      (n = s[o]) && (r = (i ? n(e, t, r) : n(r)) || r);
...
let m = class extends $ {
  ...
  firstUpdated(s) {
    var e;
    this.checkbox =
      (e = this.shadowRoot) == null ? void 0 : e.getElementById(Ae);
  }
  isOn() {
  ...
  render() {
    return d`<div class="sw"><label>${
      this.labelOff
    } <input id="${Ae}" type="checkbox" ?checked="${this.isOn()}" ?disabled="${
      this.disabled
...
b([f({ type: String })], m.prototype, "labelOn", 2);
b([f({ type: String })], m.prototype, "labelOff", 2);
b([f({ type: String })], m.prototype, "stateOn", 2);
b([f({ type: String })], m.prototype, "stateOff", 2);
b([f({ type: String })], m.prototype, "state", 2);
b([f({ type: String })], m.prototype, "color", 2);
b([f({ type: Boolean })], m.prototype, "disabled", 2);
b([f({ type: Boolean })], m.prototype, "optimistic", 2);
m = b([M("esp-switch")], m);
var Ge =
  ...
  tt = (s, e, t, i) => {
    for (
      var r = i > 1 ? void 0 : i ? et(e, t) : e, o = s.length - 1, n;
      o >= 0;
      o--
    )
      (n = s[o]) && (r = (i ? n(e, t, r) : n(r)) || r);
...
var st = Object.defineProperty,
  ...
  q = (s, e, t, i) => {
    for (
      var r = i > 1 ? void 0 : i ? it(e, t) : e, o = s.length - 1, n;
      o >= 0;
      o--
    )
      (n = s[o]) && (r = (i ? n(e, t, r) : n(r)) || r);
...
let R = class extends $ {
  constructor() {
    ...
    (this.scheme = ""),
      (this.ping = ""),
      (this.version = "2.0.5"),
      (this.config = { ota: !1, title: "", comment: "" }),
  ...
  render() {
    return d`<h1><a href="https://esphome.io/web-api" class="logo"><esp-logo></esp-logo></a>${
      ...
      (this.scheme =
        s.detail.state)}" labelOn="🌒" labelOff="☀️" stateOn="dark" stateOff="light" optimistic></esp-switch>Scheme</h2>${this.ota()}</section><section class="col"><esp-log rows="50"></esp-log></section></main>`;
  }
  static get styles() {
    return [
      G,
      we,
      y`.flex-grid{display:flex}.flex-grid .col{flex:2}.flex-grid-half{}.col{}@media (max-width:600px){.flex-grid,.flex-grid-half{display:block}.col{width:100%;margin:0 0 10px 0}}*{box-sizing:border-box}.flex-grid{margin:0 0 20px 0}h1{text-align:center;width:100%;line-height:4rem}h1,h2{border-bottom:1px solid #eaecef;margin-bottom:.25rem}h3{text-align:center;margin:.5rem 0}#beat{float:right;height:1rem}a.logo{height:4rem;float:left;color:inherit}.right{float:right}`,
    ];
  }
};
